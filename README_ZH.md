...
| 分支 | Minecraft | Loader |
|------|-----------|--------|
| `1.20.1` | 1.20.1 | Forge、Fabric |
| `1.21.1`（当前） | 1.21.1 | NeoForge |
...
- **ControlFlex** ≥ 0.8.7
- **Create** ≥ 6.0.9（[NeoForge / 上游版](https://www.curseforge.com/minecraft/mc-mods/create)）
- 仅客户端。
...
# 或：./gradlew :neoforge:build
```

依赖来源：ControlFlex API 走 JitPack（`com.github.ControlFlexMC:control-flex-api:0.8.8`，纯 Java、与 loader 无关）；1.21.1 的 Create 来自 `maven.createmod.net`。
