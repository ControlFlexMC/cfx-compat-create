...
| `1.21.1` (this one) | 1.21.1 | NeoForge |
...
- **ControlFlex** ≥ 0.8.7
- **Create** ≥ 6.0.9 ([NeoForge / upstream](https://www.curseforge.com/minecraft/mc-mods/create))
- Client side only.
...
(`com.github.ControlFlexMC:control-flex-api:0.8.8`, plain Java and loader-agnostic); Create for
1.21.1 comes from `maven.createmod.net`.
